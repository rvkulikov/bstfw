...
bin = choose(52,4)
"Ответ, шт"; bin;
"!!!Ошибка в логике и понимании формул"
...
"!!!Кажется ошибки нет, но очень странно, что в учебнике 1/32000"
...
res = pbinom(2, n, p, lower.tail=FALSE)
perc = res * 100
ratio = res / res4
...
"!!!Правильно, но первый аргумент в pbinom невключающий"